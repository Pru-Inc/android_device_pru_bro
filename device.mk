...
PRODUCT_USES_ntk_HARDWARE := true
PRODUCT_BOARD_PLATFORM := bro
...
PRODUCT_PACKAGES += \
    ...
    audio.usb.default \
    libaudio-resampler \
    libntkpostprocbundle \
    libntkvisualizer \
    libntkvoiceprocessing \
    libvolumelistener \
    tinymix
...
# Biometrics
PRODUCT_PACKAGES += \
    android.hardware.biometrics.fingerprint@2.1-service.pru_bro
...
PRODUCT_PACKAGES += \
    ...
    init.ntk.early_boot.sh \
    init.ntk.post_boot.sh \
    init.ntk.rc \
    init.ntk.sensors.sh \
    init.ntk.sh \
    init.ntk.usb.rc \
    init.ntk.usb.sh \
    init.recovery.ntk.rc \
    init.target.rc \
    ueventd.ntk.rc

PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/etc/fstab.ntk:$(TARGET_COPY_OUT_RAMDISK)/fstab.ntk
...
# Lights
PRODUCT_PACKAGES += \
    android.hardware.light@2.0-service.pru_bro
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/thermal/thermal-engine-map-bro.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-map-bro.conf \
    $(LOCAL_PATH)/thermal/thermal-engine-normal-bro.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-normal-bro.conf \
    $(LOCAL_PATH)/thermal/thermal-engine-camera-bro.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-camera-bro.conf \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/wifi/WCNSS_ntk_cfg.ini:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/WCNSS_ntk_cfg.ini
...
$(call inherit-product, vendor/pru/bro/bro-vendor.mk)
